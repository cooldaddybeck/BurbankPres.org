...
{
	NSURL *url = [NSURL URLWithString:@"http://m.twitter.com/southbaychurch"];
	[[UIApplication sharedApplication] openURL:url];
	
	//browserView.urlString = @"http://m.twitter.com/southbaychurch";
...
{
	NSURL *url = [NSURL URLWithString:@"http://m.facebook.com/?w2m&_rdr#!/profile.php?id=47346549063&view=wall&refid=17"];
	[[UIApplication sharedApplication] openURL:url];
}

-(IBAction) tappedEmail
{
	NSURL *url = [NSURL URLWithString:@"mailto://info@southbaychurch.org"];
	[[UIApplication sharedApplication] openURL:url];
}

-(IBAction) tappedPhone
{
	NSURL *url = [NSURL URLWithString:@"tel://408-890-5010"];
	[[UIApplication sharedApplication] openURL:url];
}
