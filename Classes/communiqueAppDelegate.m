...
//static NSString *const CreativeMediaFeed = @"http://www.southbaychurch.org/podcast/SouthBayChurch.xml?action=search&s=mp3";
static NSString *const CreativeMediaFeed = @"http://xsouthbaychurchx.is.livestream-api.com/livestreamiphone/SOUTHBAYCHURCH/playlist.m3u8";
static NSString *const SermonMediaFeed = @"http://www.southbaychurch.org/podcast/SouthBayChurch.xml";
static NSString *const NewsFeed = @"http://feeds.feedburner.com/ThoughtsFromAndyWood";
...
-(Boolean)hasNetworkConnection
{
	...
	SCNetworkReachabilityRef reachability = SCNetworkReachabilityCreateWithName(NULL, [@"www.southbaychurch.org" UTF8String]);
